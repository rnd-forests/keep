...
class TaskIntegrationTest extends TestCase
{
    ...
    {
        factory(Keep\Entities\Task::class)->create(['title' => 'Foo', 'priority_id' => 1, 'finishing_date' => Carbon::now()->addDays(2)]);
        factory(Keep\Entities\Task::class)->create(['title' => 'Bar', 'priority_id' => 1, 'finishing_date' => Carbon::now()->addDays(3)]);
        factory(Keep\Entities\Task::class)->create(['priority_id' => 1, 'completed' => true]);
        factory(Keep\Entities\Task::class)->create(['priority_id' => 1, 'is_failed' => true]);
        factory(Keep\Entities\Task::class)->create(['priority_id' => 2]);
    ...
    {
        factory(Keep\Entities\Task::class, 2)->create(['completed' => true]);
        factory(Keep\Entities\Task::class, 1)->create();
    ...
    {
        factory(Keep\Entities\Task::class)->create(['title' => 'Foo', 'finishing_date' => Carbon::now()->addDays(2)]);
        factory(Keep\Entities\Task::class)->create(['finishing_date' => Carbon::now()->addDays(3)]);
        factory(Keep\Entities\Task::class)->create(['finishing_date' => Carbon::now()->addDays(4)->addHours(2)]);
        factory(Keep\Entities\Task::class)->create(['title' => 'Bar', 'finishing_date' => Carbon::now()->addDays(4)->addHours(5)]);
        factory(Keep\Entities\Task::class)->create(['completed' => true]);
    ...
    {
        factory(Keep\Entities\Task::class, 2)->create(['completed' => false]);
    ...
    {
        factory(Keep\Entities\Task::class)->create(['completed' => true, 'finishing_date' => Carbon::now()->subDays(1)]);
        factory(Keep\Entities\Task::class)->create(['is_failed' => true, 'finishing_date' => Carbon::now()->subDays(2)]);
        factory(Keep\Entities\Task::class)->create(['finishing_date' => Carbon::now()->subHours(3)]);
    ...
    {
        factory(Keep\Entities\Task::class, 2)->create(['is_failed' => false]);
        factory(Keep\Entities\Task::class)->create(['title' => 'Foo', 'is_failed' => true, 'created_at' => Carbon::now()->subHours(2)]);
        factory(Keep\Entities\Task::class)->create(['title' => 'Bar', 'is_failed' => true, 'created_at' => Carbon::now()->subHours(3)]);
    ...
    public function it_fetches_upcoming_tasks()
    {
        factory(Keep\Entities\Task::class)->create(['is_failed' => true]);
        factory(Keep\Entities\Task::class)->create(['completed' => true]);
        factory(Keep\Entities\Task::class)->create(['finishing_date' => Carbon::now()]);
        factory(Keep\Entities\Task::class)->create(['finishing_date' => Carbon::now()->addDays(3)]);
        factory(Keep\Entities\Task::class)->create(['finishing_date' => Carbon::now()->addDays(5)]);
        factory(Keep\Entities\Task::class)->create(['finishing_date' => Carbon::now()->addDays(6)]);
    ...
    {
        factory(Keep\Entities\Task::class)->create(['title' => 'Foo']);
        factory(Keep\Entities\Task::class)->create(['title' => 'Foo Bar']);
        factory(Keep\Entities\Task::class)->create(['title' => 'Foo Bar Baz']);
        factory(Keep\Entities\Task::class)->create(['title' => 'Bar Baz']);
        factory(Keep\Entities\Task::class)->create(['title' => 'Baz']);
    ...
    {
        $tag1 = factory(Keep\Entities\Tag::class)->create();
        $tag2 = factory(Keep\Entities\Tag::class)->create();
        $task = factory(Keep\Entities\Task::class)->create();
    ...
    {
        $task = factory(Keep\Entities\Task::class)->make(['completed' => false]);
    ...
    {
        $task = factory(Keep\Entities\Task::class)->make(['starting_date' => Carbon::create(2014, 8, 8, 5, 45, 10)]);
    ...
    {
        $task = factory(Keep\Entities\Task::class)->make(['finishing_date' => Carbon::create(2014, 8, 8, 5, 45, 10)]);
