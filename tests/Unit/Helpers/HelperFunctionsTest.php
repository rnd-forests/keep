...
class HelperFunctionsTest extends TestCase
{
    ...
    public function testPrintObjectAttribute()
    {
        $this->assertEquals('-', print_attr(''));
        $this->assertEquals('Testing', print_attr('Testing'));
    }

    public function testCheckingForBlankCollection()
    {
        $this->assertSame(true, blank(collect([])));
        $this->assertSame(false, blank(collect([1, 2, 3, 4])));
    }
